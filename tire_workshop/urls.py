...
from core.views import dashboard, warehouse, workshop_stock, update_product_stock, update_workshop_stock, suppliers, requests_view, view_request, create_request, orders, create_order, send_order, replenish_workshop_warehouse, replenish_product
...
urlpatterns = [
    ...
    path('warehouse/replenish-warehouse/<int:warehouse_id>/', replenish_workshop_warehouse, name='replenish_workshop_warehouse'),
